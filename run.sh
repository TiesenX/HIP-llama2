...
# 4B
# srun --exclusive -p EM --gres=gpu:4 rocprof --hip-trace ./runselect /shared/erc/getpTA/main/modelbin/llama2-4b.bin -m test -f ../in/gen_in_128.txt -o ./output_test_4B.txt

# 7B
# srun --exclusive -p EM --gres=gpu:4 ./runselect /shared/erc/getpTA/main/modelbin/llama2-7b.bin -m test -f ../in/gen_in_128.txt -o ./output_test_7B.txt
